...
const AppointmentCardEmployee = ({ title, appointments, loading, error, filterStatuses }) => {
    ...
    <Card>
      ...
      <CardContent>
        {loading ? (
          ...
          <p className="text-sm text-gray-500">{t("noUpcomingAppointments")}</p>
        ) : (
...
export default AppointmentCardEmployee;